...
// The default is suitable for arbitrary rooms. Entries below are retained
// only as compatibility data for persisted legacy room keys.
...
// first nudge for a large-context room land too late to be useful. An
// absolute cadence fires on a real write-things-down rhythm in any room, on
// any model. (2026-06-29)
